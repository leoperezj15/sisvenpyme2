  <!--=====================================
    MODAL ACTIVAR CLIENTE JURIDICO
    ======================================-->

<div id="modalActivarClienteJuridico" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="POST">
        ...
        <?php
          ...
          $activarCliente = new ControladorJuridico();
          $activarCliente -> ctrActivarClienteJuridico();
         ?>
      </form>
