  <!--=====================================
    MODAL ELIMINAR CLIENTE JURIDICO
    ======================================-->

<div id="modalEliminarClienteJuridico" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="POST">
        ...
        <?php
          ...
          $eliminarCliente = new ControladorJuridico();
          $eliminarCliente -> ctrEliminarClienteJuridico();
